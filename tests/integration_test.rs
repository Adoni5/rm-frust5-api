...
fn write_test_fast5() {
    ...
    let mut multi = frust5_api::MultiFast5File::new("test2.fast5".to_string(), frust5_api::OpenMode::Append, );
    multi.create_empty_read("get_your_tsaty_read_right_here".to_string(), "5e83140edbb3559206940d49ecd665888d7da5f9".to_string(), &tracking_id, &context_tags, &channel_info).unwrap();
    multi.create_empty_read("get_your_tsaty_read_right_here2".to_string(), "5e83140edbb3559206940d49ecd665888d7da5f9".to_string(), &tracking_id, &context_tags, &channel_info).unwrap();
